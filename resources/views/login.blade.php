    ...
    <div class="row justify-content-center mt-5 mb-5 ">
        <div class="col-md-4 sm-4 lg-4">
            ...
            <main class="form-signin ">
                <div class="mx-auto"> <img src="{{url('/images/myintern.png')}}" class="d-flex mx-lg-auto img-fluid mx-auto" alt="Bootstrap Themes" width="250" height="250" loading="lazy"> </div>
