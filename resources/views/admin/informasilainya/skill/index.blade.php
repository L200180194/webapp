...
<div class="container-md mt-5 ">
    ...
    <div class="shadow p-3 mb-5 bg-body rounded mt-3">
        <div>
            <a href="/admin/informasilainya/skill/create" class="btn btn-primary mb-3">Tambah Skill</a>
        </div>
            ...
            <table class="table align-middle">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="/admin/informasilainya/skill/{{ $item->id }}/edit" style="text-decoration:none" class=" badge bg-primary"><i class="bi bi-pencil-square d-inline" style="font-size: 1.5rem"></i></a>
                            
                            <form action="/admin/informasilainya/skill/{{ $item->id }}" method="POST" class="d-inline">
                                @method('delete')
                                @csrf
