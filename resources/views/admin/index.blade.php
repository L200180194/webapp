...
<div class="container px-2 " id="custom-cards">
    <div class="row row-cols-1 row-cols-lg-3 align-items-stretch g-4 py-2">
        <div class="col">
            <a href="/admin/posisimagang" style="text-decoration:none">
        ...
        <div class="col">
            <a href="/admin/informasilainya" style="text-decoration:none">
            <div class="card card-cover h-20 overflow-hidden text-white rounded-5 shadow-lg"  style="min-height: 10rem;background-color : #fd7e14;" >
                <div class="d-flex flex-column h-100 p-2 pb-3 text-white text-shadow-1">
                    {{-- <h5 class="pt-5 mt-5 mb-4 display-6 lh-1 fw-bold">Short title, long jacket</h5> --}}
                    <div class="row g-0">
                        <div class="col-sm-3">
                        ...
                        <div class="col-sm-9">
                            <div class="card-body">
                                <h5 class="card-title">Informasi Lainya</h5>
                                <p class="card-text">Pendidikan, Prodi, Skill</p>
                            </div>
                        </div>
                    </div>
                </div>
